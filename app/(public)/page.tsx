                ...
                <div className="container mx-auto px-4 relative z-10 py-20 lg:py-28">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="max-w-2xl">
                            <div className="hidden inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 border border-white/20 rounded-full text-xs font-semibold tracking-[0.15em] uppercase mb-7 backdrop-blur-sm">
                                <span className="w-1.5 h-1.5 rounded-full bg-gold-400 animate-pulse"></span>
                                Badan Peserta Hukum &middot; Non-Departemen
                            </div>

                            <h1 className="font-serif text-4xl md:text-5xl lg:text-[3.4rem] font-bold tracking-tight mb-4 leading-[1.1]">
                                Dewan Perwakilan Daerah Tingkat I{" "}
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-300 via-gold-400 to-gold-600">
                                    DKI Jakarta
                                </span>
                            </h1>

                            <p className="text-sm md:text-base text-neutral-400 font-medium mb-8">
                                Menaungi{" "}
                            ...
                            <p className="text-lg md:text-xl text-neutral-300 mb-9 leading-relaxed">
                                Badan independen untuk Negara &amp; Masyarakat,
                                dengan kantor-kantor di seluruh Indonesia.
                                Melayani{" "}
                                <span className="text-white font-medium">
                                    {" "}
                                    Bantuan Hukum
                                </span>{" "}
                                di Luar &amp; di Dalam Pengadilan.
                            </p>
                            ...
                            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 pt-6 border-t border-white/10">
                                {[
                                    "Berita Negara No. 105 / 1954",
                                    "Tambahan LBN No. 90 / 1956",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-neutral-600 text-lg mb-6 leading-relaxed">
                                Badan Pusat Reklasseering Republik Indonesia
                                (BPR-RI) dibentuk pada 17 Agustus 1945 dan
                                diakui melalui Berita Negara No. 105 Tahun 1954
                                serta Tambahan Lembaran Berita Negara No. 90
                                Tahun 1956. BPR-RI melayani bantuan hukum di
                                luar maupun di dalam pengadilan.
                            </p>
                            <p className="text-neutral-600 text-lg mb-8 leading-relaxed">
                                Sebagai badan independen non-departemen, BPR-RI
                                menjalankan pekerjaan negara — mulai dari pidana
                                bersyarat, pengawasan lanjutan narapidana,
                                hingga menjadi mitra kerja Pemerintah RI —
                                dengan kantor-kantor di seluruh Indonesia.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 sm:items-center">
                                <Link
                                    href="/profil"
                                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-brand-600 hover:bg-brand-500 text-white rounded-lg font-medium transition-all shadow-lg shadow-brand-600/20"
                                >
                        ...
                        <div className="space-y-6">
                            <div className="bg-white p-6 rounded-2xl shadow-xl border border-neutral-100">
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-xl border border-neutral-100">
                                <div className="flex items-center gap-4">
                                    <div className="w-14 h-14 bg-gold-50 rounded-2xl flex items-center justify-center text-gold-600 flex-shrink-0">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-2xl mb-12">
                        ...
                        <p className="text-neutral-300 text-lg leading-relaxed">
                            Keberadaan BPR-RI diakui Pemerintah Republik
                            Indonesia melalui Berita Negara serta ketetapan
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100 hover:shadow-md transition-shadow group">
                            ...
                            <p className="text-neutral-600 mb-6 line-clamp-2">
                                ...
                                pengumuman, dan artikel dari BPR-RI.
                            </p>
                            <Link
                                href="/berita"
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100 hover:shadow-md transition-shadow group">
                            ...
                            <p className="text-neutral-600 mb-6 line-clamp-2">
                                Kenali lebih dekat profil jajaran pengurus dan
                                anggota Badan Pusat Reklasseering RI.
                            </p>
                            <Link
                                href="/anggota"
                                className="text-brand-600 font-medium hover:text-brand-700 flex items-center gap-1"
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100 hover:shadow-md transition-shadow group">
                            ...
                            <p className="text-neutral-600 mb-6 line-clamp-2">
                                Hubungi kami untuk pertanyaan, pengaduan, atau
                                informasi lebih lanjut terkait layanan.
                            </p>
                            <Link
                                href="/kontak"
                                className="text-brand-600 font-medium hover:text-brand-700 flex items-center gap-1"
